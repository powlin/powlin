...
<link href="../components/css/select.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="j../components/s/jquery.js"></script>
<script type="text/javascript" src="../components/js/jquery.idTabs.min.js"></script>
<script type="text/javascript" src="../components/js/select-ui.min.js"></script>
<script type="text/javascript" src="../components/editor/kindeditor.js"></script>
