...
<script type="text/javascript">
	...
	function operateFormatter(value, row) {
        return ['<button class="btn btn-primary edit">修改</button><button class="btn btn-danger del">删除</button>'].join('');
    }
		...
		<div id="custom-toolbar">
			<div class="form-inline" role="form" onsubmit="return searchSys();">
				<div class="form-group">
					<label for="code">系统编号</label> <input type="text"
						class="form-control" id="code" placeholder="请输入系统编号">
				</div>
				<div class="form-group">
					<label for="belong_to">所属公司</label> <input type="text"
